...
func init() {
	proto.RegisterFile("notifications/v1/notifications_service.proto", fileDescriptor_notifications_service_476a5eb82bf295fd)
}
func init() {
	golang_proto.RegisterFile("notifications/v1/notifications_service.proto", fileDescriptor_notifications_service_476a5eb82bf295fd)
}

var fileDescriptor_notifications_service_476a5eb82bf295fd = []byte{
